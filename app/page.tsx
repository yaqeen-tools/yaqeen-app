...
const copy = {
  ar: {
    ...
    plan_basic_limit: '40 تحليل عقد شهريًا',
    plan_pro_name: 'الاحترافية',
    plan_pro_price: '129 درهم',
    plan_pro_limit: '100 تحليل عقد شهريًا',
  ...
  en: {
    ...
    plan_basic_limit: '40 contract analyses / month',
    plan_pro_name: 'Pro',
    plan_pro_price: 'AED 129',
    plan_pro_limit: '100 contract analyses / month',
